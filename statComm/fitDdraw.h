...
TF1* fit(TH1D* h, TH1D* hMCSignal, TH1D* hMCSwapped, Double_t ptmin, Double_t ptmax, bool isPbPb, Int_t index, TString outputdir, Float_t centmin, Float_t centmax, TString rtfun="mass", Bool_t saveplot=true, Bool_t verbose=true)
{
